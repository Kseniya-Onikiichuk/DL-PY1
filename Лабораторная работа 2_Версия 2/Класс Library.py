...
class Library:
    ...
    def get_next_book_id(self) -> int:
        ...
        :return: Если в библиотеке нет книг, то 1. Если книги есть, то индентификатор последней книги, увеличенный на 1.
        """
        if self.books == []:
            return 1
        else:
            last_book = self.books[-1]
            return last_book.__dict__['id'] + 1
